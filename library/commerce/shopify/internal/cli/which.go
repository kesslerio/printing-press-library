...
Exit codes:
  ...
  2  no confident match - the query did not score against any indexed capability; fall back to '--help' or 'search' if this CLI has one`,
		Example: `  shopify-pp-cli which "stale tickets"
  shopify-pp-cli which "bottleneck"
  shopify-pp-cli which --limit 1 "send message"
  shopify-pp-cli which                                # list the full capability index`,
